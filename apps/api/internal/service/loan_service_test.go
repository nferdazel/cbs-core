...
func TestRestructureLoan_MemakaiAturanPOJKDariKonfigurasi(t *testing.T) {
	...
	svc := service.NewLoanService(nil, repo, products, nil, nil, nil, nil, nil, config, nil, nil)
...
func TestRestructureLoan_MenolakKreditCabangLain(t *testing.T) {
	...
	newService := func(loanBranch string) domain.LoanService {
		...
		config := &stubLimitConfig{values: map[string]decimal.Decimal{}}
		return service.NewLoanService(nil, repo, products, nil, nil, nil, nil, nil, config, nil, nil)
	}
...
func TestGetLoan_MenolakKreditCabangLain(t *testing.T) {
	...
	svc := service.NewLoanService(nil, repo, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	t.Run("kredit bercabang NULL tetap terlihat", func(t *testing.T) {
		...
		svcNull := service.NewLoanService(nil, repoNull, nil, nil, nil, nil, nil, nil, nil, nil, nil)
