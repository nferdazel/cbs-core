...
// RoundMoney is the ONE AND ONLY unified financial rounding function used across the core banking system.
// It applies official Banker's Rounding (Round-Half-Even, IEEE 754) to exact Rupiah.
